	.data
	.asciz "@(#)lmult.s 1.1 9/25/86 Copyright Sun Micro"
	.even
	.text
...
|J. Test	10x81
|R. Tuck	09-82
|K. Sheehan Tue Jan 17 15:59:25 PST 1984
...
RTENTRY(ulmult) | unsigned lmult
	tstb	sp@(-64)	|make sure stack is there
...
pos_result:			|here, we know the result will be positive
	...
	swap	a		|a     = a(hi)
	tstw	a		|if a(hi) == 0, cross product is zero
	bnes	1$
	moveq	#0,a
	bras	2$
1$:
