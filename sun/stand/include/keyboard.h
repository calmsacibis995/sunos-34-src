/*	@(#) keyboard.h 1.1 9/25/86 Copyright Sun Microsystems Inc	*/
/*	from keyboard.h	2.10	83/08/25	*/
...
#define	GETKEYPORT	( *(unsigned char*) PARALLEL_BASE)
...
/* Furthermore, it must not have any "transient keyboard state" bits on,
   since the keyboard is initialized with this state (eg CAPS LOCK) */
