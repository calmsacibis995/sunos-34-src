/*      @(#)vmmeter.h 1.3 87/01/05 SMI; from UCB 4.7 5/30/83        */
...
#else VAC
/*
 * No VAC, Stub out all vac_routines.
 */
#define vac_init()
#define vac_pageflush(a)
#define vac_segflush(a)
#define vac_ctxflush()
#define vac_flush(a, b)
#define vac_flushall()
#define vac_disable_kpage(a)
#define vac_enable_kpage(a)
#endif VAC
#endif KERNEL
