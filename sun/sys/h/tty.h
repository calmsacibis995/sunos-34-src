/*	@(#)tty.h 1.1 86/09/25 SMI; from UCB 4.13 82/12/19	*/
...
#define	t_rec	t_nu.t_n.T_rec		/* have a complete record */
	...
	struct	proc *t_wsel;
	caddr_t	t_linep;		/* glue */
	int	t_spl;			/* device */
	caddr_t	t_addr;			/* driver's use */
	dev_t	t_dev;			/* device */
...
#define	TS_OUT		0x008000	/* tty in use for dialout only */
