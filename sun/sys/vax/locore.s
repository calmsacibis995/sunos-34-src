/*	@(#)locore.s 1.1 86/09/25 SMI; from UCB 6.3 83/08/12	*/
...
#endif
	pushl	4+6*4(sp);
	calls	$1,_softclock			# softclock(psl)
	POPR; 
	rei
	.globl	_softint
SCBVEC(softint):
...
/* set system control block base and system page table params */
	mtpr	$_scb-KERNELBASE,$SCBB
	mtpr	$_Sysmap-KERNELBASE,$SBR
	mtpr	$_Syssize,$SLR
...
/* initialize (slightly) the pcb */
	movab	KERNSTACK(r1),PCB_KSP(r1)
	mnegl	$1,PCB_ESP(r1)
	mnegl	$1,PCB_SSP(r1)
	movl	$USRSTACK,PCB_USP(r1)
...
_Resume:
	...
	movl	P_ADDR(r0),r0
	.set	pcboff,KERNSTACK/NBPG*4
	bicl3	$0xffe00000,pcboff(r0),r0
	ashl	$PGSHIFT,r0,r0
...
Fastreclaim:
	...
	jbr	3f
2:
	subl3	P_SSIZE(r5),$(USRSTACK/NBPG),r0
	cmpl	r3,r0
...
2:
					# } else (isassv(p, v)) {
	subl3	$P1PAGES,r3,r4		# /* really P0PAGES */
	ashl	$2,r4,r4
	addl2	P_P1BR(r5),r4		#	sptopte(p, vtosp(p, v));
	clrl	r2			# 	type = !CTEXT;
3:					# }
	bitb	$0x82,3(r4)
