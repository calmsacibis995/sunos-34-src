s,@(#)asm.sed 1.1 86/09/25 SMI from UCB 4.27 83/09/08,,
...
s/calls	$0,_siron/mtpr	$0xc,$0x14/
s/calls	$1,_resume/movl	(sp)+,r0 \
	movpsl	-(sp) \
	jsb	_Resume/
...
s/calls	$3,_strncmp/cmpc3	8(sp),*(sp),*4(sp)\
	addl2	$12,sp/
s/calls	$3,_skpc/skpc	(sp),4(sp),*8(sp)\
	addl2	$12,sp/
...
s/calls	$1,__dequeue/movl	(sp)+,r0\
	remque	*(r0),r0/
s/calls	$0,_caller/movl 16(fp), r0/
