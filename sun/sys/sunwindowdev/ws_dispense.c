#ifndef lint
static	char sccsid[] = "@(#)ws_dispense.c 1.4 87/01/09";
#endif
	...
	Window *w;
{
	 ...
	 */
	    ...
	    (ws->ws_event_consumer->w_input.c_cc < sizeof (struct inputevent))){
	...
	Winlock *wlock;
{
	...
	wt_enumeratechildren(win_dont_lock,
	    ws->ws_event_consumer->w_desktop->dt_rootwin, (struct rect *)0);
