/* @(#)xdreg.h	1.1	9/25/86 Copyright 1986 Sun Microsystems, Inc. */
...
#define	XD_F751		0		/* 751 format */
#define	XD_F450		1		/* 450 compatibility format */
#define	XD_MAXCOMPAT	64		/* max sectors for 450 compatibility */
