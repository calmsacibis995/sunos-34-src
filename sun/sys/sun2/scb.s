 ...
 */
	.globl	_protoscb
_protoscb:
	jmp	dopanic:w	| 0x0	Force panic
	jmp	dotrace:w	| 0x1	Force stack trace
	.long	buserr		| 0x2	Bus Error
	.long	addrerr		| 0x3	Address Error
	.long	illinst		| 0x4	Illegal Instruction
	.long	zerodiv		| 0x5 	Zero divide
	.long	chkinst		| 0x6	CHK instruction
	.long	trapv		| 0x7	TRAPV instruction
