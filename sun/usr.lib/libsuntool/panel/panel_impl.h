...
#define USING_WALK_MENUS	0x00000100
...
#define using_walk_menus(panel)		((panel)->status & USING_WALK_MENUS)
...
#define PUT_KEY			KEY_LEFT(6)
#define OPEN_KEY		KEY_LEFT(7)
#define GET_KEY			KEY_LEFT(8)
#define FIND_KEY		KEY_LEFT(9)
#define DELETE_KEY		KEY_LEFT(10)
