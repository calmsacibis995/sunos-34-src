#ifndef lint
static        char sccsid[] = "@(#)panel_scroll.c 1.4 87/01/07 Copyr 1984 Sun Micro";
#endif
 ...
 *
 *
 * The "rounding rule" is to round up (chouse the high_ip) when scrolling
 * down (backward in the file).  Rounding only happens when there is
 * an intersection.  (a "fraction" of an ip).
 */
static
