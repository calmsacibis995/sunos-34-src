#ifndef lint
static char sccsid[] = "@(#)scribe.c 1.1 86/09/25 Copyr 1983 Sun Micro";
#endif
...
_core_scribe(font, ch, min, max, npts, pts)
	short font, *npts;
	char ch;
	short	*min, *max; register short *pts;
{
	register short i;   register char *c;
...
_core_scribextent(font, ch, min, max, npts)
	short font, *npts;
	char ch;
	short	*min, *max;
{
