#ifndef	lint
static	char sccsid[] = "@(#)ntfy_node.c 1.4 87/01/07 Copyr 1985 Sun Micro";
#endif
...
pkg_private_data int	ntfy_nodes_avail;	/* Count of nodes in ntfy_node_free */
pkg_private_data int	ntfy_node_blocks;	/* Count of trips to heap for nodes
