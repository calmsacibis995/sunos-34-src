#ifndef	lint
static	char sccsid[] = "@(#)ntfy_protect.c 1.4 87/01/07 Copyr 1985 Sun Micro";
#endif
...
#include "ntfy.h"
#include "ndet.h"	/* For ndet_send_delayed_sigs */

Notify_error	notify_errno;

pkg_private_data int	ntfy_sigs_blocked;   /* count of nesting of signal blocking*/
pkg_private_data int	ntfy_interrupts;     /* count of interrupts handling (0 or 1) */
pkg_private_data u_int ntfy_sigs_delayed; /* Bit mask of signals received while in
				        critical section */
