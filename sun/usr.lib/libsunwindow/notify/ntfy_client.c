#ifndef	lint
static	char sccsid[] = "@(#)ntfy_client.c 1.4 87/01/07 Copyr 1985 Sun Micro";
#endif
...
#include "ntfy.h"
#include "ndis.h"	/* For ndis_default_prioritizer */

/* Variables used in paranoid enumerator (see ntfy_condition) */
pkg_private_data NTFY_CLIENT *ntfy_enum_client;
pkg_private_data NTFY_CLIENT *ntfy_enum_client_next;
