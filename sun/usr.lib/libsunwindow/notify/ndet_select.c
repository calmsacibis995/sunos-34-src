#ifndef	lint
static	char sccsid[] = "@(#)ndet_select.c 1.6 87/01/07 Copyr 1985 Sun Micro";
#endif
...
static	int	ndet_select_ibits, ndet_select_obits, ndet_select_ebits;
...
select(nfds, readfds, writefds, exceptfds, timeout)
	register int nfds, *readfds, *writefds, *exceptfds;
	struct timeval *timeout;
{
	...
	ndet_select_ibits = ndet_select_obits = ndet_select_ebits = 0;
