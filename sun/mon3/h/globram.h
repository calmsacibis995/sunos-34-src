...
#if defined(SIRIUS) || defined(SUN3F)
	unsigned int            g_bottom;      	/* vars to reflect the */
	unsigned int            g_top;       	/* defines in dpy.h  */
	unsigned int            g_left;
