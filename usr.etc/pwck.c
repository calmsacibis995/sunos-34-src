#ifndef lint
static	char sccsid[] = "@(#)pwck.c 1.1 86/09/25 SMI"; /* from S5R2 1.4 */
#endif
...
#define ERROR2c "Netgroup field NULL"
#define ERROR2d "First char in netgroup not lower case alpha"
#define ERROR2e	"Bad character(s) in netgroup"
