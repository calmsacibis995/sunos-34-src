        .data 
        .asciz  "@(#)s_cos.s 1.1 86/09/25 Copyr 1984 Sun Micro"
        .even
        .text
...
| single precison cos function from Cody and Waite "Software Manual for
...
MHALF:	.long	0xBFE00000	| -5.000000e-01
	.long	0x0
PI:	.long	0x400921FB	| 3.141593e+00
	.long	0x54442D1A
PIOTWO:	.long	0x3FC90FDB	| 1.570796e+00
...
| the sgn flag will be eored to the result to get the right sign
	movl	a6@(-4),d7			
	movl	d7,d1				| unpack argument
	jsr	f_unpk
	movl	#0,a6@(-12)	 		| 0 -> sgn flag 
	bclr	#15,d3				| take abs of unpacked x
...
3$:	jsr	d_pack				| make xn double precision ; xn now in d0/d1
	...
	jsr	d_unpk				| range reduction done: convert back to cosgle
	jsr	f_pack
