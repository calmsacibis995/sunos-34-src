#ifndef lint
static char sccsid[] = "@(#)args.c 1.1 86/12/24 Copyright 1985 Sun Micro";	/* from UCB 4.3 */
#endif not lint
 ...
 * are substrings of other options must occur later; that is, with -lp vs
 * -l, -lp must be first.  Also, while (most) booleans occur more than
 * once, the last default value is the one actually assigned. 
 */
struct pro {
