#ifndef lint
static char sccsid[] = "@(#)io.c 1.5 86/12/24 Copyright 1985 Sun Micro";	/* from UCB 4.3 10/21/82 */
#endif
...
{				/* dump_line is the routine that actually
				 ...
				 * any comments */
    register int cur_col, temp_col, target_col;
