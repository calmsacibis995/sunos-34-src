#ifndef lint
static	char sccsid[] = "@(#)ipcs.c 1.1 86/09/25 SMI"; /* from SYSV.2 1.5 */
#endif
...
#ifdef notdef
	if (!check_sys(name, mem)) {
		fprintf(stderr, "ipcs:  namelist out of phase with memory file\n");
		exit(1);
	}
#endif
