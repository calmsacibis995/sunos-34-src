#ifndef lint
static	char sccsid[] = "@(#)main.c 1.1 86/09/24 SMI"; /* from UCB 4.1 82/05/11 */
#endif
...
{       register int i;
	...
	/*
	 * setbuf needed because of self-saving garbage which happens after
	 * stdio has been initialized.
	 */
	setbuf(stdout, NULL);
	reenter++;
	setuid(getuid());
