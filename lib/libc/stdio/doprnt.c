#ifndef lint
static	char sccsid[] = "@(#)doprnt.c 1.1 86/09/24 SMI"; /* from S5R2 3.2 */
#endif
...
register FILE	*iop;
{
	...
	/* bufferend is a pointer to the end of iop's buffer, if it exists.
	/* For dummy file descriptors (_IOSTRG set in iop->_flag),
	/* bufferend may be meaningless.				*/
