#ifndef lint
static	char sccsid[] = "@(#)scan.c 1.1 86/09/24 SMI"; /* from S5R2 1.4 */
#endif
...
mainp1( argc, argv ) int argc; char *argv[]; {  /* control multiple files */
	...
	char *release = "PCC/PCCrx UNIX 6.X";
