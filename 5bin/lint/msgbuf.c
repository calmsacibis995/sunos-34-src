#ifndef lint
static	char sccsid[] = "@(#)msgbuf.c 1.1 86/09/24 SMI"; /* from S5R2 1.4 */
#endif
...
short	msgbuf[ NUMMSGS ] = {
	...
	0,	/* [45] "function %.8s has illegal storage class" */
	...
	0,	/* [68] "illegal register declaration %.8s" */
	...
	0,	/* [128] "arg list in declaration" */
	0,	/* [129] "block nesting too deep" */
	0,	/* [130] "%s declared as parameter to non-function" */
	0,	/* [131] "declaration of %s hides parameter" */
	0,	/* [132] "switch expression must have integer type" */
	0,	/* [133] "illegal character: '%c'" */
	0,	/* [134] "zero-length array element" */
	0,	/* [135] "cannot take size of a function" */
#ifdef FLEXNAMES
	0,	/* [136] "`%s' may be indistinguishable from `%s' due to internal name truncation" */
#endif
};
...
short	msgtype[ NUMMSGS ] = {
	...
	STRINGTY,	/* [45] "function %.8s has illegal storage class" */
	...
	STRINGTY,	/* [68] "illegal register declaration %.8s" */
	...
	PLAINTY,	/* [128] "arg list in declaration" */
	PLAINTY,	/* [129] "block nesting too deep" */
	STRINGTY,	/* [130] "%.8s declared as parameter to non-function" */
	STRINGTY,	/* [131] "declaration of %.8s hides parameter" */
	PLAINTY,	/* [132] "switch expression must have integer type" */
	CHARTY,		/* [133] "illegal character: '%c'" */
	PLAINTY,	/* [134] "zero-length array element" */
	PLAINTY,	/* [135] "cannot take size of a function" */
#ifdef FLEXNAMES
	DBLSTRTY,	/* [136] "`%s' may be indistinguishable from `%s' due to internal name truncation" */
#endif
};
