#ifndef lint
static	char *sccsid = "@(#)diffreg.c 1.1 86/09/24 SMI; from UCB 4.16 86/03/29";
#endif
...
char	*chrtran_tab;	/* translation table for case-folding */
...
diffreg()
{
	...
	chrtran_tab = (iflag? cup2low : clow2low);
	origfile1 = file1;
	origfile2 = file2;
...
check()
{
	...
	register char *chrtran = chrtran_tab;
