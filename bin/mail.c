#ifndef lint
static	char sccsid[] = "@(#)mail.c 1.1 86/09/24 SMI"; /* from UCB 4.25 5/1/85 */
#endif
	...
	char *msg;
{
	...
	if (addr.sin_family == 0) {
		...
		addr.sin_addr.s_net = 127;
		addr.sin_addr.s_host = 0;
		addr.sin_addr.s_lh = 0;
		addr.sin_addr.s_impno = 1;
