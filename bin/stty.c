...
#ifndef lint
static	char sccsid[] = "@(#)stty.c 1.1 86/09/24 SMI"; /* from UCB 5.4 86/04/04 */
#endif not lint

/*
 * stty: set teletype modes
 */
...
struct
{
	...
	"even",		EVENP, 0, 0, 0, 0, 0,
	"-even",	0, EVENP, 0, 0, 0, 0,
	"odd",		ODDP, 0, 0, 0, 0, 0,
	"-odd",		0, ODDP, 0, 0, 0, 0,
	"raw",		RAW, 0, 0, 0, 0, 0,
	"-raw",		0, RAW, 0, 0, 0, 0,
	"cooked",	0, RAW, 0, 0, 0, 0,
	"-nl",		CRMOD, 0, 0, 0, 0, 0,
	"nl",		0, CRMOD, 0, 0, 0, 0,
	"echo",		ECHO, 0, 0, 0, 0, 0,
	"-echo",	0, ECHO, 0, 0, 0, 0,
	"LCASE",	LCASE, 0, 0, 0, 0, 0,
	"lcase",	LCASE, 0, 0, 0, 0, 0,
	"-LCASE",	0, LCASE, 0, 0, 0, 0,
	"-lcase",	0, LCASE, 0, 0, 0, 0,
	"-tabs",	XTABS, 0, 0, 0, 0, 0,
	"tabs",		0, XTABS, 0, 0, 0, 0,
	"tandem",	TANDEM, 0, 0, 0, 0, 0,
	"-tandem",	0, TANDEM, 0, 0, 0, 0,
	"cbreak",	CBREAK, 0, 0, 0, 0, 0,
	"-cbreak",	0, CBREAK, 0, 0, 0, 0,
	"cr0",		CR0, CR3, 0, 0, 0, 0,
	"cr1",		CR1, CR3, 0, 0, 0, 0,
	"cr2",		CR2, CR3, 0, 0, 0, 0,
	"cr3",		CR3, CR3, 0, 0, 0, 0,
	"tab0",		TAB0, XTABS, 0, 0, 0, 0,
	"tab1",		TAB1, XTABS, 0, 0, 0, 0,
	"tab2",		TAB2, XTABS, 0, 0, 0, 0,
	"nl0",		NL0, NL3, 0, 0, 0, 0,
	"nl1",		NL1, NL3, 0, 0, 0, 0,
	"nl2",		NL2, NL3, 0, 0, 0, 0,
	"nl3",		NL3, NL3, 0, 0, 0, 0,
	...
	"bs0",		BS0, BS1, 0, 0, 0, 0,
	"bs1",		BS1, BS1, 0, 0, 0, 0,
	"33",		CR1, ALLDELAY, 0, 0, 0, 0,
	"tty33",	CR1, ALLDELAY, 0, 0, 0, 0,
	"37",		FF1+CR2+TAB1+NL1, ALLDELAY, 0, 0, 0, 0,
	"tty37",	FF1+CR2+TAB1+NL1, ALLDELAY, 0, 0, 0, 0,
	"05",		NL2, ALLDELAY, 0, 0, 0, 0,
	"vt05",		NL2, ALLDELAY, 0, 0, 0, 0,
	"tn",		CR1, ALLDELAY, 0, 0, 0, 0,
	"tn300",	CR1, ALLDELAY, 0, 0, 0, 0,
	"ti",		CR2, ALLDELAY, 0, 0, 0, 0,
	"ti700",	CR2, ALLDELAY, 0, 0, 0, 0,
	"tek",		FF1, ALLDELAY, 0, 0, 0, 0,
	"crtbs",	0, 0, LCRTBS, LPRTERA, 0, 0,
	"-crtbs",	0, 0, 0, LCRTBS, 0, 0,
	"prterase",	0, 0, LPRTERA, LCRTBS+LCRTKIL+LCRTERA, 0, 0,
	"-prterase",	0, 0, 0, LPRTERA, 0, 0,
	"crterase",	0, 0, LCRTERA, LPRTERA, 0, 0,
	"-crterase",	0, 0, 0, LCRTERA, 0, 0,
	"crtkill",	0, 0, LCRTKIL, LPRTERA, 0, 0,
	"-crtkill",	0, 0, 0, LCRTKIL, 0, 0,
	"tilde",	0, 0, LTILDE, 0, 0, 0,
	"-tilde",	0, 0, 0, LTILDE, 0, 0,
	"mdmbuf",	0, 0, LMDMBUF, 0, 0, 0,
	"-mdmbuf",	0, 0, 0, LMDMBUF, 0, 0,
	"litout",	0, 0, LLITOUT, 0, 0, 0,
	"-litout",	0, 0, 0, LLITOUT, 0, 0,
	"pass8",	0, 0, LPASS8, 0, 0, 0,
	"-pass8",	0, 0, 0, LPASS8, 0, 0,
	"tostop",	0, 0, LTOSTOP, 0, 0, 0,
	"-tostop",	0, 0, 0, LTOSTOP, 0, 0,
	"flusho",	0, 0, LFLUSHO, 0, 0, 0,
	"-flusho",	0, 0, 0, LFLUSHO, 0, 0,
	"nohang",	0, 0, LNOHANG, 0, 0, 0,
	"-nohang",	0, 0, 0, LNOHANG, 0, 0,
#ifdef notdef 0, 0,
	"etxack",	0, 0, LETXACK, 0, 0, 0,
	"-etxack",	0, 0, 0, LETXACK, 0, 0,
#endif 0, 0,
	"ctlecho",	0, 0, LCTLECH, 0, 0, 0,
	"-ctlecho",	0, 0, 0, LCTLECH, 0, 0,
	"pendin",	0, 0, LPENDIN, 0, 0, 0,
	"-pendin",	0, 0, 0, LPENDIN, 0, 0,
	"decctlq",	0, 0, LDECCTQ, 0, 0, 0,
	"-decctlq",	0, 0, 0, LDECCTQ, 0, 0,
	"noflsh",	0, 0, LNOFLSH, 0, 0, 0,
	"-noflsh",	0, 0, 0, LNOFLSH, 0, 0,
	"nopost",	0, 0, 0, 0, NOPOST, 0,
	"-nopost",	0, 0, 0, 0, 0, NOPOST,
	"noisig",	0, 0, 0, 0, NOISIG, 0,
	"-noisig",	0, 0, 0, 0, 0, NOISIG,
	"stopb",	0, 0, 0, 0, STOPB, 0,
	"-stopb",	0, 0, 0, 0, 0, STOPB,
	0,
};
...
#define	lpit(what,str) \
	if (all==2||(xmode&what)) { \
		fprintf(stderr,str+((xmode&what)!=0)); any++; \
	}
	any = 0;
	lpit(NOPOST, "-nopost ");
	lpit(NOISIG, "-noisig ");
